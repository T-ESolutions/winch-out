...
//        $row->body_en = $request->body_en;
        ...
        $row->is_drop_off = $request->is_drop_off;
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.services.edit', compact('row'));
    }

    public function update(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'row_id' => 'required|exists:services,id',
            'title_ar' => 'required',
            'title_en' => 'required',
            'is_drop_off' => 'required|in:0,1',
            'price' => 'required',
        ...
        $row = Service::whereId($request->row_id)->first();
    ...
    public function delete(Request $request)
    {
        ...
        $row = Service::where('id', $request->row_id)->first();
...
//                if ($auth->can('sliders.update')) {
                $buttons .= '<a href="' . route('admin.services.edit', [$row->id]) . '" class="btn btn-primary btn-circle btn-sm m-1" title="تعديل">
