            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="services_table">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
...
@section('script')
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                                    <td style="text-align: right"><p>عنوان التقرير : الخدمات</p>' +
    ...
    <script>
        ...
        $("#services_table").find('.group-checkable').change(function () {
        ...
        $("#services_table").on('change', 'tbody tr .checkboxes', function () {
    ...
    <script>
        ...
        $bulkDeleteBtn.click(function (e) {
            var $checkedBoxes = $('#services_table input[type=checkbox]:checked').not('.select_all');
