    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form action="{{route('admin.services.update')}}" method="post" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" >
                @csrf
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">عنوان الخدمة (بالعربي)</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="title_ar" value="{{$row->title_ar}}" class="form-control mb-2" placeholder="عنوان الشاشة الترحيبية (بالعربي)" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">عنوان الخدمة (بالإنجليزي)</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="title_en" value="{{$row->title_en}}" class="form-control mb-2" placeholder="عنوان الشاشة الترحيبية (بالإنجليزي)" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            {{--                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>--}}
                                            <!--end::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">سعر الخدمة المبدأي (بالعربي)</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                <input type="number" required name="price" class="form-control mb-2"
                                                       placeholder="سعر الخدمة المبدأي" value="{{$row->price}}" step="any" min="1"/>
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <div class="card card-flush py-4">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <!--begin::Select2-->
                                                        <select name="is_drop_off" required class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="هل لها وجهه؟" id="kt_ecommerce_add_product_status_select">
                                                            <option></option>
                                                            <option value="1" {{$row->is_drop_off == 1 ? "selected" : ""}}>نعم</option>
                                                            <option value="0" {{$row->is_drop_off == 0 ? "selected" : ""}}>لا</option>
                                                        </select>
                                                        <!--end::Select2-->
                                                        <!--begin::Description-->
                                                    {{--                                <div class="text-muted fs-7">Set the product status.</div>--}}
