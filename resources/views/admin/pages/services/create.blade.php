                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.screens')}}" class="text-muted text-hover-primary">الخدمات</a>
                        </li>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                     ...
                                     style="background-image: url({{url('admin/dist/assets/media/svg/files/blank-image.svg')}})">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" required name="title_ar" class="form-control mb-2"
                                                       placeholder="عنوان الخدمة (بالعربي)" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" required name="title_en" class="form-control mb-2"
                                                       placeholder="عنوان الخدمة (بالإنجليزي)" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            {{--                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>--}}
                                            <!--end::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="number" required name="price" class="form-control mb-2"
                                                       placeholder="سعر الخدمة المبدأي" value="" step="any" min="1"/>
                                            ...
                                            <!--end::Description-->
                                                ...
                                                <div class="card card-flush py-4">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-toolbar">
                                                            <div class="rounded-circle bg-success w-15px h-15px"
                                                                 id="kt_ecommerce_add_product_is_drop_off"></div>
                                                        </div>
                                                        <!--begin::Card toolbar-->
                                                    </div>
                                                    <!--end::Card header-->
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <!--begin::Select2-->
                                                        <select name="is_drop_off" required class="form-select mb-2" data-control="select2"
                                                                data-hide-search="true" data-placeholder="هل له وجهه"
                                                                id="kt_ecommerce_add_product_is_drop_off_select">
                                                            <option></option>
